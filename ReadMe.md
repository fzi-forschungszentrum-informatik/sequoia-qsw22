...
## Usage
To reproduce the results from the paper just run the python scripts *Evaluation.py for the corresponding pattern. 

If you want to run an evaluation on new simulation results run the SimualationsRunner.py.